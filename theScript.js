...
function startDrag(e) {
  ...
  if (freshed) {
    freshed = false;
    whatWedoSliderMaxLeft = parseInt(
      whatWeDoSliderRect.left - whatWeDoSectionRect.left
    );
  }
}
function doDrag(e) {
  ...
  if (
    newRect.left - rectSection.left + deltaX < whatWedoSliderMaxLeft &&
...
function applyVelocity() {
  ...
  if (newRect.right < rectSection.right) {
    ...
    lastPos =
      -whatWeDoSlider.offsetWidth + rectSection.right - rectSection.left;
